...
const ProductPage = () => {
  ...
  <a href="/kitchenware" className="breadcrumb-link">Kitchenware</a>
  <span className="breadcrumb-separator">&gt;</span>
  <a href="/bowl" className="breadcrumb-link">Bowl</a>
  <span className="breadcrumb-separator">&gt;</span>
  <span className="breadcrumb-current">Wooden Bowl</span>
</div>
...
<div className="policy-section-container">
  ...
  <div className="policy-section">
    <div className="policy">
      <img src={delivery} alt="Assured Delivery" className="policy-icon" />
      <span className="policy-text">Assured Delivery</span>
    </div>
    <div className="policy">
      <img src={cancellation} alt="Easy Cancellation" className="policy-icon" />
      <span className="policy-text">Easy Cancellation</span>
    </div>
    <div className="policy">
      <img src={warranty} alt="1 Year Warranty" className="policy-icon" />
      <span className="policy-text">1 Year Warranty</span>
    </div>
    <div className="policy">
      <img src={replacement} alt="7 Days Replacement" className="policy-icon" />
  ...
  <p className="additional-text">
    Perfect for serving salads, fruits, snacks, and desserts. <br /> Add a rustic,
    elegant touch to your dining table or gatherings. <br /> A thoughtful gift option
    for housewarmings, weddings, or festive occasions.
  </p>
</div>
